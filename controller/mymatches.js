...
//Deletematch
var deleteButton = document.getElementById("deletematch")
//Gamle http adresse lokal
//http://localhost:7071/api/NyFunktionEksamen
deleteButton.addEventListener("click", function(){
    var userid= document.getElementById("userid").value
    var liked_userid = document.getElementById("txtliked_userid").value
    fetch("https://nyeksamenprojekt.azurewebsites.net/api/deletematch?",{
            method: 'POST',
            body: JSON.stringify({
                userid:userid,
